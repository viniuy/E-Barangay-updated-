          ...
          <div className="lg:col-span-2">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  {currentStep === 1 && 'Please provide your personal details as they appear on your passport'}
                  {currentStep === 2 && 'Upload the required documents in PDF or JPG format'}
                  {currentStep === 3 && 'Complete your payment to process the application'}
                  {currentStep === 4 && 'Review all information before submitting your application'}
                </CardDescription>
              </CardHeader>
                ...
                {currentStep === 2 && (
                  <div className="space-y-4">
                    <Alert>
                      ...
                      <AlertDescription>
                        Please ensure all documents are clear, readable, and in PDF or JPG format (max 5MB each).
                      </AlertDescription>
                    </Alert>
                      ...
                      <div key={index} className="border border-gray-200 rounded-lg p-4">
                        <div className="flex items-start justify-between mb-3">
                          <div>
                            ...
                            <p className="text-sm text-gray-600 mt-1">
                              {index === 0 && 'Main identification page of passport'}
                              {index === 1 && 'Recent passport-sized photograph with white background'}
                              {index === 2 && 'Hotel booking confirmation or travel itinerary'}
                              {index === 3 && 'Return or onward flight booking confirmation'}
                              {index === 4 && 'Last 3 months bank statements'}
                              {index === 5 && 'Travel insurance policy document'}
                            </p>
                          </div>
                        ...
                        <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                          ...
                          <Button 
                            variant="outline" 
                            size="sm"
                            onClick={() => alert(`File upload for: ${requirement}\n\nSupported formats: PDF, JPG, PNG\nMax size: 5MB\n\nClick OK to simulate file selection.`)}
                          >
                            Choose File
                          </Button>
                        </div>
                  ...
                  <div className="space-y-6">
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                      <div className="flex items-center justify-between">
                        <div>
                          <h4 className="font-medium text-blue-900">Visa Application Fee</h4>
                          <p className="text-sm text-blue-700">Tourist/Business Visa (30 days)</p>
                        </div>
                        <div className="text-2xl font-bold text-blue-900">USD 35</div>
                      </div>
                    </div>
                    ...
                    <Alert>
                      ...
                      <AlertDescription>
                        Your payment is secured with 256-bit SSL encryption and processed by our certified payment gateway.
                      </AlertDescription>
                    </Alert>
                  </div>
                )}
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <Button 
                  ...
                  className="w-full justify-start" 
                  size="sm"
                  onClick={() => alert('Downloading application guide...\n\nThe guide includes:\n• Step-by-step instructions\n• Required documents\n• Common issues\n• Contact information')}
                >
